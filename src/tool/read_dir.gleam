...
Read a file at a given path, relative to the current working directory.
Returns the contents of the target file.
"
...
pub fn spec() -> tool_spec.ToolSpec {
  tool_spec.ToolSpec(name: "read_dir", description: description, parameters: [
